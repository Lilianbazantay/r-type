 ...
 */
void ServerPacket::FillReceivedData(std::vector<uint8_t> received) {
 ...
 * @param received data that has been received
 */
void ServerPacket::FillActionType(std::vector<uint8_t> received) {
 ...
 * @param received data that has been received
 */
void ServerPacket::FillPayloadSize(std::vector<uint8_t> received) {
    uint32_t act = received[2];
 ...
 * @param received data that has been received
 */
void ServerPacket::FillIP(std::vector<uint8_t> received) {
    uint8_t offset = 3;
    IP =
 ...
 * @param received data that has been received
 */
void ServerPacket::FillPort(std::vector<uint8_t> received, size_t offset) {
